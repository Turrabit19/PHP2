...
$router->get('detail-teacher/{id}', [\App\Controllers\TeacherController::class, 'getIDTeacher']);
$router->post('edit-teacher/{id}', [\App\Controllers\TeacherController::class, 'editTeacher']);
$router->get('del-teacher/{id}', [\App\Controllers\TeacherController::class, 'delTeacher']);
